...
import {category, languages, tagOptions} from "../../../../Data";
...
const BasicInfoTab: React.FC<BasicInfoTabProps> = ({
	...
	const handleSelectChange = (event: any) => {
		const {name, value} = event.target; // This will be either "Level" or "Language"
		onUpdateData({[name]: value});
	};
	...
	const handleTagsChange = (selectedOptions: any) => {
		onUpdateData({Tags: selectedOptions || []}); // Store the selected tags or an empty array if none are selected
	};
